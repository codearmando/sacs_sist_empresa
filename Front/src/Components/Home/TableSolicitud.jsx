...
function TableSolicitud({user}) {
  ...
  const consola = () =>{
    ListFilterSolicitudEmpresa()
    console.log('FilterSolicitud', FilterSolicitud)
  }
          ...
          <Box className='modal_Details_Solicitud'>
                <PopupComponent
                    ...
                    <BodyDetails
                        ...
                        tipo_empresa = {detallesSolicitud.tipo_empresa}
                        tipo_solicitud = {detallesSolicitud.tipo_solicitud}
                        nombre_solicitud = {detallesSolicitud.nombre_solicitud}
                        tip_area = {detallesSolicitud.tip_area}
                        activ_economica = {detallesSolicitud.activ_economica}
                        nombre_categoria = {detallesSolicitud.nombre_categoria}
                        nombre_apellido_propietario = {detallesSolicitud.nombre_apellido_propietario}
                        nombre_apellido_regente = {detallesSolicitud.nombre_apellido_regente}
                        nombre_apellido_representante = {detallesSolicitud.nombre_apellido_representante}
                        motivo_solicitud = {detallesSolicitud.motivo_solicitud}
                        // tableData={tableData}
                    />
                    }
                />

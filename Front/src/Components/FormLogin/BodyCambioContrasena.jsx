...
function BodyCambioContrasena() {
    ...
    const datos_Preguntas = async () =>{    
        ...
        // console.log('resp_data preguntas',resp_data)
    ...
    const Validacion_Preguntas = () =>{
        ...
        // console.log('datosUsuario validate: ',datosUsuario)
        ...
        if( datosUsuario.primera_respuesta == Respuesta1.dato.toUpperCase().trim() && 
            ...
            Swal.fire(
                'Error!',
                `Algunas Respuestas no son Correctas. Por favor Berifique y no dejar ningun campo vacio` ,
                'error'
            )
        }
    ...
    <>
        ...
        <Box component='div' sx={{width:'70%', margin:'auto', boxShadow:'2px 2px 6px 6px #ddd',borderRadius:'10px',p:'1rem'}}>
            <Box component='div' className='tit_popup'  >
                <center>
                    <Typography variant="h6" sx={{color:'#fff',pl:'22rem'}}>Cambio de Contraseña</Typography>
                </center>
            </Box>
                            ...
                            <Box className='cont_collapse' sx={{mt:1}}>
                                <Collapse in={open}>
                                    ...
                                    <Box 
                                        sx={{mt:2,float:'right'}}
                                        >
                                        <Button variant="contained" id='btn_next' color="info" onClick={() => nextformstep()} tabIndex={-1}  >
                                ...
                                <Collapse in={open2}>
                                    <Stack sx={{ width: '100%', mt:1 }} spacing={2}>
                                        <Alert severity="warning">
                                            <strong>El correo no es Correctos</strong> o <strong>No esta REGISTRADO . " POR FAVOR BERIFIQUE "</strong>!
                                        </Alert>
                                    </Stack>
                                </Collapse>     
                            </Box>
                            ...
                            <Box component='div'>
                                <Typography variant="p" color="primary" sx={{mt:3}}>Responder las Preguntas para continuar:</Typography>
                                    ...
                                    <Box 
                                        sx={{mt:2,float:'right'}}
                                        >
                                        <Button variant="contained" id='btn_next' color="warning" sx={{mr:2}} onClick={() => beforeformstep()} tabIndex={-1}>
                                            Volver
                                        </Button>
                                    ...
                                    <Collapse in={collapseComprobar}>
                                        ...
                                        <Box 
                                            sx={{mt:2,float:'right'}}
                                            >
                                            <Button  variant="contained" id='btn_next' color="primary" onClick={() => nextformstep()} tabIndex={-1} >

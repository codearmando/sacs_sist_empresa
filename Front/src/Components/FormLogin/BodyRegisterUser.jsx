...
function BodyRegisterUser() {
  ...
  useEffect(() =>{
    if(
      ...
      !expresionsRegulars.textoRegex.test(nameEmpresa.dato) || nameEmpresa.dato === null || nameEmpresa.dato === undefined
      ){
      setDiseabledNextEmpresa(true)
    }
    else{
    ...
    <>
      <Box component='div' sx={{p:'1rem', position:'relative',maxHeight:'100%',width:'100%',
        ...
        <Box component='div' sx={{my:'1rem',textAlign:'center',}}>
          <Typography variant="h5" color="error"><strong>Registrarse</strong></Typography>
        </Box>
                  ...
                  <Box>
                      ...
                      <Box className='cont_collapse' sx={{mt:1}}>
                          <Collapse in={openppoder}>
                              ...
                              <Box>
                                <Box>
                                  <Typography variant="p" > Datos de Poder: </Typography>
                                </Box>
                                <Grid container spacing={2} sx={{mt:1}}>
                          ...
                          <Box 
                                sx={{mt:2,float:'right'}}
                                >
                                <Button variant="contained" id='btn_next' color="warning"  onClick={() => beforeformstep()} >
                                    Regresar
                                </Button>
              ...
              <Box component='form' className='form_ciudadano' id='form_step' onSubmit={HandleSubmitSecondPropietario}>
                    <Box>
                        <FormControl>
                            ...
                            >
                                <FormControlLabel value="female" control={<Radio />} label="Si" onClick={() =>{ setOpenOption(true); setOpenOptionSecondPropietario(false); setUbicacionseconpropietario(null)}} />
